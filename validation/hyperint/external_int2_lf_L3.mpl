# External Int2 Method.12A -- exact HyperInt input for LF master L3
# label [0, 0, 0, -1, 0, 0, -1]; certified basis unchanged; audit artifact only.
...
f := x2^(ep + 1) * (x2 + 1)^(ep - 1) * (x5 + 1)^(ep) * (x7 + 1)^(-ep - 1) * (r*x2*x5 + x2*x7 + x7 + 1)^(ep - 2):
